package com.example.group10.circularProgressbar;
...
public class CircleProgressBar extends View {
    ...
    public void setProgress(float progress) {
        ...
        invalidate(); // Notify the view to redraw itself (the onDraw method is called)
    }
    ...
    //get and set our values from defined styleable and initialize our Paint objects
